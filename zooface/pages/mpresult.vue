<template>
	<view>
			...
			<view class="main" >
				<image
					src="http://img.zooseefun.net/mpresult/download.png"
					style="width: 96upx;height: 96upx;position: absolute;right: 13upx;"
					@click="download"
				></image>
				...
				<image class="modify" src="http://img.zooseefun.net/mpresult/modify.png" @click = "()=>{flag = true; oldmotto=motto;}"></image>
			</view>
